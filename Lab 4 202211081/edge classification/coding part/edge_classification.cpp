...
public:
    Vertex* end1;
    Vertex* end2;
    int edgeType; // 0 for Tree edge, 1 for Back edge, 2 for Forward edge, 3 for Cross edge

    Edge() {
        end1 = nullptr;
        end2 = nullptr;
        edgeType = -1; // Default to unknown
    }
...
Vertex vertices[5]; // Global array of vertices
